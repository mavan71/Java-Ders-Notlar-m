...
public class C09_replace_raplaceAll {
        ...
        public static void main(String[] args) {
           //***************Hocanın Yaptıkları***************
            ...
            //Kendi  yaptıklarım********************
        String str1 ="Hayat Herkese Güzeldir";
            System.out.println("Hayat Herkese Güzeldir");
            System.out.println(str1.replace("e", "*"));
            System.out.println(str1.replaceFirst("H", ":-)"));
            String elme="Java canlar  hepiniz Güzel insanlarsınız 123456789 #$½{[[]}";
            System.out.println(elme.replaceAll("\\s", "*"));
            System.out.println(elme.replaceAll("\\S", "*"));
            System.out.println(elme.replaceAll("\\w", "*"));
            System.out.println(elme.replaceAll("\\W", "*"));
            System.out.println(elme.replaceAll("\\d", "+"));
            System.out.println(elme.replaceAll("\\D", "+"));
            Scanner scan=new Scanner(System.in);
            System.out.println("ad giriniz");
            String adi=scan.nextLine();
            System.out.println("Suy ad giriniz");
            String soyAd=scan.nextLine();
            System.out.println("kredi kart no giriniz");
            String kart=scan.nextLine();
            System.out.println("isim : "+adi);
            String yeniAdi=(adi.charAt(0) + adi.substring(1).replaceAll("\\w", "*"));
            String yeniSoyadi=(soyAd.charAt(0) + soyAd.substring(1).replaceAll("\\w", "*"));
            String yaniKK="**** **** **** "+kart.substring(12);
            System.out.println("Adı :" + yeniAdi+" Soy Adı : "+ yeniSoyadi+" KrediKartı :"+ yaniKK);
           ...
           /** replace()
            ...
            String str7 = "javaCAN'lara selam bolcana offer :) ";
            System.out.println("str7 = " + str7);//javaCAN'lara selam bolcana offer :)
            System.out.println(str7.replace("a", "*"));//j*v*CAN'l*r* sel*m bolc*n* offer :)
            System.out.println(str7.replace("can", "$"));//javaCAN'lara selam bol$a offer :)
            ...
            System.out.print("Dadaş hele bir adını   giresen : ");
            String adii = input.nextLine();

            System.out.print("Dadaş hele bir soyadını   giresen : ");
            String soyadii = input.nextLine();

            System.out.print("Dadaş hele bir kk no   giresen : ");
            String kkn = input.nextLine();

            String yeniAdii = ad.charAt(0) + ad.substring(1).replaceAll("\\w", "*");
            String yeniSoyadii = soyad.charAt(0) + soyad.substring(1).replaceAll("\\w", "*");
            String yeniKKi = "**** **** **** **** " + kk.substring(12);
