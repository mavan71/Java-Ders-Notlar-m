...
public class C09_equals {
    public static void main(String[] args) {
        ...
        ArrayList<String> ulkelist4 = new ArrayList<>(Arrays.asList("Güba", "Polkonya", "Dingiltere", "Amerigonya","Alamanya"));//çuval
        System.out.println("ulkelist4.equals(ulkelist1) = " + ulkelist4.equals(ulkelist1));
    }
}
